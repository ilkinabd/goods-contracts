...
// @generated from protobuf file "common/search/v1/search.proto" (package "common.search.v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message common.search.v1.Pagination
 */
...
/**
 * @generated from protobuf message common.search.v1.Search
 */
export interface Search {
    /**
     * @generated from protobuf field: repeated common.search.v1.Field fields = 1;
     */
    fields: Field[];
}
/**
 * @generated from protobuf message common.search.v1.Field
 */
...
class Pagination$Type extends MessageType<Pagination> {
    constructor() {
        super("common.search.v1.Pagination", [
...
/**
 * @generated MessageType for protobuf message common.search.v1.Pagination
 */
export const Pagination = new Pagination$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Search$Type extends MessageType<Search> {
    constructor() {
        super("common.search.v1.Search", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Search): Search {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated common.search.v1.Field fields */ 1:
    ...
    internalBinaryWrite(message: Search, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated common.search.v1.Field fields = 1; */
...
/**
 * @generated MessageType for protobuf message common.search.v1.Search
 */
export const Search = new Search$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Field$Type extends MessageType<Field> {
    constructor() {
        super("common.search.v1.Field", [
...
/**
 * @generated MessageType for protobuf message common.search.v1.Field
 */
