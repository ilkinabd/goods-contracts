...
// @generated from protobuf file "goods/product/v1/service.proto" (package "goods.products.v1", syntax proto3)
// tslint:disable
...
import { Sort } from "../../../common/search/v1/sort";
import { Search } from "../../../common/search/v1/search";
import { Pagination } from "../../../common/search/v1/search";
import { Product } from "./product";
/**
 * @generated from protobuf message goods.products.v1.CreateProductRequest
 */
...
/**
 * @generated from protobuf message goods.products.v1.CreateProductResponse
 */
export interface CreateProductResponse {
    /**
     * @generated from protobuf field: goods.products.v1.Product product = 1;
     */
    product?: Product;
}
/**
 * @generated from protobuf message goods.products.v1.AllProductsRequest
 */
export interface AllProductsRequest {
    /**
     * @generated from protobuf field: common.search.v1.Pagination pagination = 1;
     */
    pagination?: Pagination;
    /**
     * @generated from protobuf field: common.search.v1.Search search = 2;
     */
    search?: Search;
    /**
     * @generated from protobuf field: common.search.v1.Sort sort = 3;
     */
    sort?: Sort;
}
/**
 * @generated from protobuf message goods.products.v1.AllProductsResponse
 */
export interface AllProductsResponse {
    /**
     * @generated from protobuf field: repeated goods.products.v1.Product products = 1;
     */
    products: Product[];
}
/**
 * @generated from protobuf message goods.products.v1.ProductByIDRequest
 */
...
/**
 * @generated from protobuf message goods.products.v1.ProductByIDResponse
 */
...
/**
 * @generated from protobuf message goods.products.v1.UpdateProductRequest
 */
...
/**
 * @generated from protobuf message goods.products.v1.UpdateProductResponse
 */
export interface UpdateProductResponse {
}
/**
 * @generated from protobuf message goods.products.v1.DeleteProductRequest
 */
...
/**
 * @generated from protobuf message goods.products.v1.DeleteProductResponse
 */
...
class CreateProductRequest$Type extends MessageType<CreateProductRequest> {
    constructor() {
        super("goods.products.v1.CreateProductRequest", [
...
/**
 * @generated MessageType for protobuf message goods.products.v1.CreateProductRequest
 */
...
class CreateProductResponse$Type extends MessageType<CreateProductResponse> {
    constructor() {
        super("goods.products.v1.CreateProductResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateProductResponse): CreateProductResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* goods.products.v1.Product product */ 1:
    ...
    internalBinaryWrite(message: CreateProductResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* goods.products.v1.Product product = 1; */
        if (message.product)
...
/**
 * @generated MessageType for protobuf message goods.products.v1.CreateProductResponse
 */
...
class AllProductsRequest$Type extends MessageType<AllProductsRequest> {
    constructor() {
        super("goods.products.v1.AllProductsRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AllProductsRequest): AllProductsRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* common.search.v1.Pagination pagination */ 1:
                    message.pagination = Pagination.internalBinaryRead(reader, reader.uint32(), options, message.pagination);
                    break;
                case /* common.search.v1.Search search */ 2:
                    message.search = Search.internalBinaryRead(reader, reader.uint32(), options, message.search);
                    break;
                case /* common.search.v1.Sort sort */ 3:
...
/**
 * @generated MessageType for protobuf message goods.products.v1.AllProductsRequest
 */
...
class AllProductsResponse$Type extends MessageType<AllProductsResponse> {
    constructor() {
        super("goods.products.v1.AllProductsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AllProductsResponse): AllProductsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated goods.products.v1.Product products */ 1:
    ...
    internalBinaryWrite(message: AllProductsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated goods.products.v1.Product products = 1; */
...
/**
 * @generated MessageType for protobuf message goods.products.v1.AllProductsResponse
 */
...
class ProductByIDRequest$Type extends MessageType<ProductByIDRequest> {
    constructor() {
        super("goods.products.v1.ProductByIDRequest", [
...
/**
 * @generated MessageType for protobuf message goods.products.v1.ProductByIDRequest
 */
...
class ProductByIDResponse$Type extends MessageType<ProductByIDResponse> {
    constructor() {
        super("goods.products.v1.ProductByIDResponse", [
            { no: 1, name: "product", kind: "message", T: () => Product }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message goods.products.v1.ProductByIDResponse
 */
...
class UpdateProductRequest$Type extends MessageType<UpdateProductRequest> {
    constructor() {
        super("goods.products.v1.UpdateProductRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message goods.products.v1.UpdateProductRequest
 */
...
class UpdateProductResponse$Type extends MessageType<UpdateProductResponse> {
    constructor() {
        super("goods.products.v1.UpdateProductResponse", []);
    }
...
/**
 * @generated MessageType for protobuf message goods.products.v1.UpdateProductResponse
 */
...
class DeleteProductRequest$Type extends MessageType<DeleteProductRequest> {
    constructor() {
        super("goods.products.v1.DeleteProductRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message goods.products.v1.DeleteProductRequest
 */
...
class DeleteProductResponse$Type extends MessageType<DeleteProductResponse> {
    constructor() {
        super("goods.products.v1.DeleteProductResponse", []);
    }
...
/**
 * @generated MessageType for protobuf message goods.products.v1.DeleteProductResponse
 */
export const DeleteProductResponse = new DeleteProductResponse$Type();
/**
 * @generated ServiceType for protobuf service goods.products.v1.ProductService
 */
export const ProductService = new ServiceType("goods.products.v1.ProductService", [
