...
/**
 * @generated from protobuf service goods.products.v1.ProductService
 */
export interface IProductServiceClient {
    /**
     * @generated from protobuf rpc: AllProducts(goods.products.v1.AllProductsRequest) returns (goods.products.v1.AllProductsResponse);
     */
    allProducts(input: AllProductsRequest, options?: RpcOptions): UnaryCall<AllProductsRequest, AllProductsResponse>;
    /**
     * @generated from protobuf rpc: ProductByID(goods.products.v1.ProductByIDRequest) returns (goods.products.v1.ProductByIDResponse);
     */
    productByID(input: ProductByIDRequest, options?: RpcOptions): UnaryCall<ProductByIDRequest, ProductByIDResponse>;
    /**
     * @generated from protobuf rpc: CreateProduct(goods.products.v1.CreateProductRequest) returns (goods.products.v1.CreateProductResponse);
     */
    createProduct(input: CreateProductRequest, options?: RpcOptions): UnaryCall<CreateProductRequest, CreateProductResponse>;
    /**
     * @generated from protobuf rpc: UpdateProduct(goods.products.v1.UpdateProductRequest) returns (goods.products.v1.UpdateProductResponse);
     */
    updateProduct(input: UpdateProductRequest, options?: RpcOptions): UnaryCall<UpdateProductRequest, UpdateProductResponse>;
    /**
     * @generated from protobuf rpc: DeleteProduct(goods.products.v1.DeleteProductRequest) returns (goods.products.v1.DeleteProductResponse);
     */
