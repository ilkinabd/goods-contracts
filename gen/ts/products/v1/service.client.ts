...
/**
 * @generated from protobuf service products.v1.ProductService
 */
export interface IProductServiceClient {
    /**
     * @generated from protobuf rpc: AllProducts(products.v1.AllProductsRequest) returns (products.v1.AllProductsResponse);
     */
    allProducts(input: AllProductsRequest, options?: RpcOptions): UnaryCall<AllProductsRequest, AllProductsResponse>;
    /**
     * @generated from protobuf rpc: ProductByID(products.v1.ProductByIDRequest) returns (products.v1.ProductByIDResponse);
     */
    productByID(input: ProductByIDRequest, options?: RpcOptions): UnaryCall<ProductByIDRequest, ProductByIDResponse>;
    /**
     * @generated from protobuf rpc: CreateProduct(products.v1.CreateProductRequest) returns (products.v1.CreateProductResponse);
     */
    createProduct(input: CreateProductRequest, options?: RpcOptions): UnaryCall<CreateProductRequest, CreateProductResponse>;
    /**
     * @generated from protobuf rpc: UpdateProduct(products.v1.UpdateProductRequest) returns (products.v1.UpdateProductResponse);
     */
    updateProduct(input: UpdateProductRequest, options?: RpcOptions): UnaryCall<UpdateProductRequest, UpdateProductResponse>;
    /**
     * @generated from protobuf rpc: DeleteProduct(products.v1.DeleteProductRequest) returns (products.v1.DeleteProductResponse);
     */
